...
echo Cloning Kernel
git clone https://github.com/CandyDevices/kernel_xiaomi_msm8953 -b c9.0 kernel/xiaomi/msm8953
#git clone https://github.com/bhi768/kernel_xiaomi_msm8953/ -b c9.0-r34 kernel/xiaomi/msm8953

echo Cloning Vendor
git clone https://github.com/SecretIngredients/proprietary_vendor_xiaomi -b c9.0 vendor/xiaomi
#git clone https://github.com/bhi768/proprietary_vendor_xiaomi/ -b c9.0 vendor/xiaomi

echo Cloning Device Tree
#echo Enter branch
#read fbranch
git clone https://github.com/candydevices/device_xiaomi_mido/ -b c9.0 device/xiaomi/mido
